...
- The executable entry point is `apps/blood_flow.cc`.
- The model and IDA callbacks are implemented in `source/blood_flow_system.cc` and declared in `include/blood_flow_system.h`.
