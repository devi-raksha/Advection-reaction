...
#include "../include/DG_advection_reaction_embedded.h"
...
template <int dim, int spacedim>
void
get_function_jump(const FEInterfaceValues<dim, spacedim> &fe_iv,
...
template <int dim, int spacedim>
void
AdvectionReaction<dim, spacedim>::initialize_params(const std::string &filename)
{
...
template <int dim, int spacedim>
void
AdvectionReaction<dim, spacedim>::parse_string(const std::string &parameters)
{
...
template <int dim, int spacedim>
void
AdvectionReaction<dim, spacedim>::setup_system()
{
  if (!fe)
    {
...
template <int dim, int spacedim>
void
AdvectionReaction<dim, spacedim>::assemble_system()
{
...
template <int dim, int spacedim>
void
AdvectionReaction<dim, spacedim>::solve()
...
template <int dim, int spacedim>
void
AdvectionReaction<dim, spacedim>::refine_grid()
...
template <int dim, int spacedim>
void
AdvectionReaction<dim, spacedim>::output_results(const unsigned int cycle) const
...
template <int dim, int spacedim>
void
AdvectionReaction<dim, spacedim>::compute_error()
...
template <int dim, int spacedim>
void
AdvectionReaction<dim, spacedim>::compute_local_projection_and_estimate()
{
  using Iterator = typename DoFHandler<dim, spacedim>::active_cell_iterator;
...
template <int dim, int spacedim>
void
AdvectionReaction<dim, spacedim>::run()
  ...
  for (unsigned int cycle = 0; cycle < n_refinement_cycles; ++cycle)

    {
      ...
      if (cycle == 0)
        ...
        {
          GridGenerator::hyper_cube<dim, spacedim>(triangulation);
...
// template class AdvectionReaction<2, 2>;
