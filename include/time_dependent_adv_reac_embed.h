...
class AdvectionReaction : public ParameterAcceptor
...
private:
    ...
    // SparseMatrix<double> assemble_mass_matrix;
    SparseMatrix<double> mass_matrix;        // mass matrix
    SparseMatrix<double> advec_react_matrix; // advection + reaction operator
    SparseMatrix<double> system_matrix_time; // (M/dt + A)
    ...
    FunctionParser<spacedim> boundary_conditions;
